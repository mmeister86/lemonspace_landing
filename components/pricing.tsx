      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-8 grid gap-6 md:mt-20 md:grid-cols-3">
          ...
          <Card className="relative">
            <span className="bg-primary absolute inset-x-0 -top-3 mx-auto flex h-6 w-fit items-center rounded-full px-3 py-1 text-xs font-medium text-primary-foreground ring-1 ring-inset ring-border ring-offset-1 ring-offset-background">
              {t("pro.badge")}
            </span>
            ...
            <CardHeader>
              ...
              <Button asChild className="mt-4 w-full bg-lemonspace text-white">
