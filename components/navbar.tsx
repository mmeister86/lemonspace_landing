    ...
    return (
        <header>
            <nav
                ...
                className={`fixed top-0 z-50 w-full border-b border-dashed bg-background/50 backdrop-blur transition-all duration-200 dark:bg-background/50 lg:bg-background/30 lg:dark:bg-transparent ${isScrolled ? "border-transparent shadow-sm" : "border-border"
                    }`}
            >
